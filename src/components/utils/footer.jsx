            ...
            <div className="col-12 col-sm-6 col-md-5 col-lg-4 col-xl-3">
                <div className="single_footer_area mb-100">
                    ...
                    <div className="footer_social_area mt-15">
                        <a to="https://www.facebook.com/elsok.net/" href="https://www.facebook.com/elsok.net/" target="_blank" rel="noopener noreferrer"><i className="fa fa-facebook" aria-hidden="true" ></i></a>
                    </div>
                </div>
            </div>
            ...
            <div className="row align-items-center">
                ...
                <div className="col-12 col-md-6">
                    <div className="copywrite_text">
                        <p>Made with <i className="fa fa-heart" aria-hidden="true"></i> by <Link to="#">ELSOK TEAM</Link></p>
                    </div>
                </div>
            </div>
        </div>
